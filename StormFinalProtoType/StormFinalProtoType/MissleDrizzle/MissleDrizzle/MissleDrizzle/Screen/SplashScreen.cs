...
namespace MissileDrizzle.Screen
{
    class SplashScreen : ScreenState
    {
        ...
        public override void draw(SpriteBatch pSpriteBatch)
        {
            ...
            pSpriteBatch.DrawString(Test, mMainLanguage[(int)mCurrentLanguage].splash_Title,new Vector2(350,300),Color.White, 0.0f, Vector2.Zero, 5.0f,SpriteEffects.None,0.0f);
            pSpriteBatch.End();
        }
